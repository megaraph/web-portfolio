const email = "raph_murillo@dlsu.edu.ph";
const location = "Manila City, Philippines";
const university = "De La Salle University";
const linkedin = "https://www.linkedin.com/in/raphael-m-860261246/";
const github = "https://github.com/megaraph";
